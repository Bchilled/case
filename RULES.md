# BRENT SNOW — OPERATOR RULES
# Every AI, every model, every session must read this file first.

## RULE 1 — DRAFT ONLY. NEVER SEND.
- Claude drafts emails. Brent sends.
- When Brent says "send it" → put it in Drafts and say "it's in your drafts"
